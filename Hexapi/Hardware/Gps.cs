...
namespace Hexapi.Service.Hardware
{
    internal sealed class Gps
    {
        ...
        {
            _gpsSerialDevice = await HexapiService.SerialDeviceHelper.GetSerialDeviceAsync("AH03F3RYA", 57600, TimeSpan.FromMilliseconds(100), TimeSpan.FromMilliseconds(100));
