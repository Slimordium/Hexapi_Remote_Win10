...
namespace Hardware.Xbox
{
    public class XboxIkController
    {
        ...
        internal void XboxDeviceEvent(XboxData xboxData)
        {
            if (xboxData == null) return;

            var ikParams = GetIkParams(xboxData);
        ...
        //internal async void DpadDirectionChanged(XboxData xboxData)
        //{
        ...
        private IkParams GetIkParams(XboxData xboxData)
        {
            var ikParams = new IkParams();

            var rightStick = xboxData.RightStick;
            var leftStick = xboxData.LeftStick;
            ...
            ikParams.LengthX = -xboxData.LeftTrigger.Map(0, 10000, 0, _ikLimits.TravelLengthXlimit);

            ikParams.LengthX += xboxData.RightTrigger.Map(0, 10000, 0, _ikLimits.TravelLengthXlimit);

            return ikParams;
        }

        //private void SetBodyHorizontalOffset(XboxData xboxData)
        //{
        //    switch (sender.Action)
        //    {
        //        case EventType.Left:
