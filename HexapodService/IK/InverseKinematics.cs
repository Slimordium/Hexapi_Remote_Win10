...
namespace Hexapod.IK
{
    ...
    internal class InverseKinematics
    {
        ...
        {
            //AI03GJKCA
            _serialDevice = await HexapodService.SerialDeviceHelper.GetSerialDeviceAsync("AI03GJKCA", 115200, TimeSpan.FromMilliseconds(1000), TimeSpan.FromMilliseconds(1000)); //The PI 3 on-board UART
